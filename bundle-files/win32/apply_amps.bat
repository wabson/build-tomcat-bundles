...
:start
echo This script will apply all the AMPs in %ALF_HOME%amps\alfresco to the alfresco.war and all the AMPs in %ALF_HOME%amps\share to share.war in %CATALINA_HOME%\webapps
if ""%1"" == ""nowait"" goto nowait1
echo Press control-c to stop this script . . .
pause
:nowait1
"%JAVA_HOME%\bin\java" -jar "%ALF_HOME%bin\alfresco-mmt.jar" install "%ALF_HOME%amps\alfresco" "%CATALINA_HOME%\webapps\alfresco.war" -directory "%2"
